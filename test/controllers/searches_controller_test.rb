...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference("Search.count") do
      post searches_url, params: { search: { count: @search.count, query: @search.query, result_count: @search.result_count } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { count: @search.count, query: @search.query, result_count: @search.result_count } }
